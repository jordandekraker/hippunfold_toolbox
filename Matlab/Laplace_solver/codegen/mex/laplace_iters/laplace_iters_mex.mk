START_DIR = /home/jordandekraker/graham/scratch/Hippocampal_AutoTop/tools/Laplace_solver

MATLAB_ROOT = /usr/local/MATLAB/R2018a
MAKEFILE = laplace_iters_mex.mk

include laplace_iters_mex.mki


SRC_FILES =  \
	laplace_iters_data.c \
	laplace_iters_initialize.c \
	...
	laplace_iters_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = laplace_iters_mex
MEX_FILE_NAME = $(MEX_FILE_NAME_WO_EXT).mexa64
TARGET = $(MEX_FILE_NAME)

SYS_LIBS = -lmwimfilter -lmwnhood 
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/laplace_iters"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/laplace_iters/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/laplace_iters/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/laplace_iters/%.cu
	$(CC) $(CCFLAGS) "$<"
